  ...
  <div id="app">
    <header>
        <div class="container">
            ...
            <div class="head-link">
                <a href="https://www.qiang100.com" target="_blank">网站首页</a>
...
.head-logo{width:400px;height: @headHeight;/* background: indigo; */float: left;line-height: @headHeight;cursor: default;
    position: relative;left: 20px;
    span{display: inline-block;width: 120px;height: calc(@headHeight - 28px);/* background:pink; */vertical-align: middle;
        border-right:1px solid #fff;
        p{width: 100%;height: 24px;line-height: 24px;color: #fff;position: relative;top:-3px;}
        p:first-child{font-size: 20px;font-weight: 500;font-weight: 600;}
    }
    span:last-child{border-right:none;
        p{position: relative;left: 30px;}
        p:first-child{font-size: 16px;font-weight: normal}
    }
}

.head-link{width: 300px;height: @headHeight;float: right;line-height: @headHeight;
    a{font-size: 18px;color: #fff;margin-right: 30px;opacity: .5;/* border:2px solid #fff; */border-radius: 100px;
...
@optionHeight:400px;
.option{width: 100%;height:auto ;float: left;margin-top:60px;}
ul.option-list{width: 360px;height: @optionHeight;float: left;cursor: default;margin-right:50px;
    li{width: 100%;height: 60px;margin-bottom: 30px;position: relative;
        input[type="checkbox"]{width: 20px;height: 20px;margin:20px;float: left;position: relative}

        p {color:#9A9A9A;width: 220px;float: right;position: relative;top:15px;left:-80px;}
        p span{font-size: 18px;color: #333;position: relative;top:-5px;}
...
.option-content{width:650px;height: auto;/* background: pink; */float: left;

}


footer{width: 100%;height: 50px;float: left;text-align: center;font-size: 16px;color: #666;margin-top:50px;
    .foot-line{height: 1px;background: #ddd}
    span{width: 460px;background: #fff;padding: 10px 50px;position: relative;top:-10px;}
}
